...
<body>
    <form id="form2" runat="server">
        ...
        <asp:Button ID="btnTicketType" runat="server" style="z-index: 1; left: 680px; top: 505px; position: absolute" Text="Manage Ticket Type" OnClick="Button7_Click" />
        ...
        <p>
        <asp:Button ID="btnTicketType2" runat="server" style="z-index: 1; left: 680px; top: 471px; position: absolute" Text="Manage Ticket Type" OnClick="Button13_Click" />
        </p>
