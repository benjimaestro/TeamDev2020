...
<body>
    <form id="form2" runat="server">
        ...
        <asp:Label ID="Label10" runat="server" style="z-index: 1; left: 102px; top: 453px; position: absolute" Text="Leicester - Birmingham"></asp:Label>
        <asp:Label ID="Label12" runat="server" style="z-index: 1; left: 420px; top: 455px; position: absolute" Text="14:25"></asp:Label>
        </p>
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 745px; top: 450px; position: absolute" Text="Manage Connection" />
        <p>
        <asp:Label ID="Label11" runat="server" style="z-index: 1; left: 302px; top: 454px; position: absolute; right: 586px;" Text="12/06/2021"></asp:Label>
        </p>
        <asp:Label ID="Label18" runat="server" style="z-index: 1; left: 514px; top: 455px; position: absolute" Text="Public"></asp:Label>
    </form>
</body>
</html>
