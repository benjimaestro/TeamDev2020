...
<body>
    <form id="form2" runat="server">
        ...
        <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 214px; top: 220px; position: absolute"></asp:TextBox>
        ...
        <asp:TextBox ID="txtRepeatPassword" runat="server" style="z-index: 1; left: 214px; top: 260px; position: absolute"></asp:TextBox>
