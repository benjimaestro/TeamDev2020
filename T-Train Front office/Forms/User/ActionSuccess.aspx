...
<body>
    <form id="form2" runat="server">
        ...
        <p>
        <asp:Button ID="btnLogout" runat="server" style="z-index: 1; left: 847px; top: 25px; position: absolute" Text="Logout" OnClick="btnLogout_Click" />
            <asp:Label ID="lblPaymentFailure" runat="server" style="z-index: 1; left: 202px; top: 198px; position: absolute" Text="Sorry, your payment could not be completed. Try again and if this continues, contact us directly." Visible="False"></asp:Label>
        ...
        <asp:Label ID="lblStaticModSuccess" runat="server" style="z-index: 1; left: 330px; top: 245px; position: absolute" Text="Success! The connection/ticket type has been modified." Visible="False"></asp:Label>
        <asp:Label ID="lblStaticDelSuccess" runat="server" style="z-index: 1; left: 340px; top: 268px; position: absolute" Text="Success! The connection/ticket type has been deleted." Visible="False"></asp:Label>
