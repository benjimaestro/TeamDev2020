...
<body>
    <form id="form2" runat="server">
        <div>
            <asp:Label ID="Label20" runat="server" style="z-index: 1; left: 207px; top: 183px; position: absolute" Text="Your purchase was succesful. You can view your tickets by pressing My tickets button anytime."></asp:Label>
        ...
        <asp:Button ID="btnLogout" runat="server" style="z-index: 1; left: 880px; top: 27px; position: absolute" Text="Logout" OnClick="btnLogout_Click" />
            <asp:Label ID="Label21" runat="server" style="z-index: 1; left: 203px; top: 224px; position: absolute" Text="Sorry, your payment could not be completed. Try again and if this continues, contact us directly."></asp:Label>
            <asp:Label ID="Label22" runat="server" style="z-index: 1; left: 342px; top: 267px; position: absolute" Text="Success! New connection/ticket type has been added."></asp:Label>
        </p>
        <asp:Label ID="Label23" runat="server" style="z-index: 1; left: 335px; top: 305px; position: absolute" Text="Success! The connection/ticket type has been modified."></asp:Label>
        <asp:Label ID="Label24" runat="server" style="z-index: 1; left: 341px; top: 339px; position: absolute" Text="Success! The connection/ticket type has been deleted."></asp:Label>
        <asp:Label ID="Label25" runat="server" style="z-index: 1; left: 386px; top: 378px; position: absolute" Text="Success! The ticket has been cancelled."></asp:Label>
    </form>
</body>
</html>
