...
<body>
    <form id="form2" runat="server">
        <div>
            <asp:Label ID="lblPaymentSuccess" runat="server" style="z-index: 1; left: 207px; top: 183px; position: absolute" Text="Your purchase was succesful. You can view your tickets by pressing My tickets button anytime." Visible="False"></asp:Label>
        ...
        <asp:Button ID="btnLogout" runat="server" style="z-index: 1; left: 880px; top: 27px; position: absolute" Text="Logout" OnClick="btnLogout_Click" />
            <asp:Label ID="lblPaymentFailure" runat="server" style="z-index: 1; left: 203px; top: 224px; position: absolute" Text="Sorry, your payment could not be completed. Try again and if this continues, contact us directly." Visible="False"></asp:Label>
