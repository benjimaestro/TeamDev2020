...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblLogoutNotice" runat="server" style="z-index: 1; left: 158px; top: 147px; position: absolute; width: 626px;" Text="You were logged out.&lt;br&gt;If you did not press the button to log out, most likely, your session expired.&lt;br&gt;In that case, please log in again.&lt;br&gt;If you are not yet registered, feel free to create a free account and enjoy fussle-free train ticket booking service!" Font-Bold="True"></asp:Label>
        <asp:Label ID="Label18" runat="server" style="z-index: 1; left: 368px; top: 311px; position: absolute" Text="All rights reserved (at) T-Train 2020"></asp:Label>
        <asp:Button ID="btnLogin" runat="server" style="z-index: 1; left: 729px; top: 27px; position: absolute; " Text="Login" OnClick="Button3_Click" Font-Size="X-Large" />
        <asp:Button ID="btnSignup" runat="server" style="z-index: 1; left: 829px; top: 27px; position: absolute; right: -25px;" Text="Register" OnClick="Button2_Click" Font-Size="X-Large" />
        </div>
    </form>
</body>
</html>
