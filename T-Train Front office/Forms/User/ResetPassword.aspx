...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label25" runat="server" style="z-index: 1; left: 270px; top: 210px; position: absolute; right: 320px; height: 59px;" Text="You will have received a special code to your email address. Type that code into the box above to confirm the account belongs to you." Font-Bold="True"></asp:Label>
