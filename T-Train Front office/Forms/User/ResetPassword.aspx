...
<body>
    <form id="form1" runat="server">
        ...
        <p>
        <asp:Label ID="Label3" runat="server" style="z-index: 1; left: 336px; top: 181px; position: absolute; right: 573px;" Text="Reset code:"></asp:Label>
        <asp:TextBox ID="txtResetCode" runat="server" style="z-index: 1; left: 451px; top: 181px; position: absolute"></asp:TextBox>
        <asp:Label ID="Label24" runat="server" style="z-index: 1; left: 321px; top: 293px; position: absolute" Text="New Password:"></asp:Label>
        <asp:TextBox ID="txtNewPass" runat="server" style="z-index: 1; left: 456px; top: 293px; position: absolute"></asp:TextBox>
        ...
        <asp:Label ID="Label17" runat="server" style="z-index: 1; left: 347px; top: 450px; position: absolute; right: 422px;" Text="All rights reserved (at) T-Train 2020"></asp:Label>
