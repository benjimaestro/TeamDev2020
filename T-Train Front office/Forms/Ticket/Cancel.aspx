...
<body>
    <form id="form2" runat="server">
        ...
        <asp:Label ID="lblConnDate" runat="server" style="z-index: 1; left: 418px; top: 267px; position: absolute"></asp:Label>
        <asp:Label ID="lblConnTime" runat="server" style="z-index: 1; left: 618px; top: 267px; position: absolute"></asp:Label>
        <asp:Button ID="btnCustomer" runat="server" style="z-index: 1; left: 470px; top: 333px; position: absolute" Text="Back to Customer" OnClick="btnCustomer2_Click" Visible="False" />
