...
<body>
    <form id="form2" runat="server">
        ...
        <asp:Button ID="btnConnections2" runat="server" style="z-index: 1; left: 566px; top: 455px; position: absolute" Text="All connections" OnClick="btnConnections_Click" Visible="False" />
        <p>
            &nbsp;</p>
        <p>
            &nbsp;</p>
