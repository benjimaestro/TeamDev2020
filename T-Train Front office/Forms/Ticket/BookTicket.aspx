...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblConnTime" runat="server" style="z-index: 1; left: 554px; top: 250px; position: absolute"></asp:Label>
        </p>
        ...
        <p>
        <asp:Label ID="lblConnPrice" runat="server" style="z-index: 1; left: 696px; top: 250px; position: absolute"></asp:Label>
        ...
        <p>
        <asp:Label ID="lblConnDate" runat="server" style="z-index: 1; left: 399px; top: 250px; position: absolute; "></asp:Label>
        </p>
    </form>
</body>
</html>
