<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Connection.aspx.vb" Inherits="T_Train_Front_office.Connection" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblHeaderWelcome" runat="server" Font-Size="XX-Large" style="z-index: 1; left: 200px; top: 22px; position: absolute" Text="Welcome to T-Train"></asp:Label>
        </p>
        <div>
        </div>
        ...
        <asp:Button ID="Button8" runat="server" style="z-index: 1; left: 876px; top: 27px; position: absolute" Text="My tickets" />
        <p>
        ...
        <asp:Label ID="Label5" runat="server" style="z-index: 1; left: 455px; top: 383px; position: absolute" Text="Time:"></asp:Label>
            ...
            <asp:Button ID="Button4" runat="server" style="z-index: 1; left: 171px; top: 532px; position: absolute" Text="Delete Connection" />
        </p>
        <p>
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 529px; top: 384px; position: absolute"></asp:TextBox>
            <asp:Button ID="Button5" runat="server" style="z-index: 1; left: 352px; top: 458px; position: absolute" Text="Add connection/Save changes" />
        </p>
    </form>
</body>
</html>
