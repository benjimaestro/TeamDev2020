<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Settings.aspx.vb" Inherits="T_Train_Front_office.Settings" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Button10" runat="server" style="z-index: 1; left: 531px; top: 25px; position: absolute" Text="Staff Dashboard" />
        ...
        <asp:Label ID="Label19" runat="server" style="z-index: 1; left: 381px; top: 115px; position: absolute" Text="Change your account settings here"></asp:Label>
        <p>
        <asp:Label ID="Label2" runat="server" style="z-index: 1; left: 413px; top: 216px; position: absolute; height: 19px" Text="Email:"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 467px; top: 217px; position: absolute"></asp:TextBox>
        <asp:Label ID="Label3" runat="server" style="z-index: 1; left: 368px; top: 380px; position: absolute; right: 504px;" Text="Current Password:"></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" style="z-index: 1; left: 522px; top: 381px; position: absolute"></asp:TextBox>
        <asp:Label ID="Label6" runat="server" style="z-index: 1; left: 387px; top: 647px; position: absolute" Text="First Name:"></asp:Label>
        <asp:TextBox ID="TextBox4" runat="server" style="z-index: 1; left: 484px; top: 648px; position: absolute"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox5" runat="server" style="z-index: 1; left: 489px; top: 688px; position: absolute"></asp:TextBox>
        <asp:Label ID="Label8" runat="server" style="z-index: 1; left: 389px; top: 789px; position: absolute" Text="Address:"></asp:Label>
        <asp:TextBox ID="TextBox6" runat="server" style="z-index: 1; left: 489px; top: 739px; position: absolute"></asp:TextBox>
            <asp:Label ID="Label9" runat="server" style="z-index: 1; left: 374px; top: 737px; position: absolute" Text="Date of Birth:"></asp:Label>
        <asp:TextBox ID="TextBox7" runat="server" style="z-index: 1; left: 522px; top: 483px; position: absolute"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox3" runat="server" style="z-index: 1; left: 524px; top: 427px; position: absolute"></asp:TextBox>
        <asp:Button ID="Button4" runat="server" style="z-index: 1; left: 406px; top: 534px; position: absolute" Text="Update Password" />
        </p>
        <asp:Label ID="Label20" runat="server" style="z-index: 1; left: 166px; top: 255px; position: absolute" Text="You cannot change your email address. If you wish to use a different email, please register a new account."></asp:Label>
        ...
        <asp:Label ID="Label23" runat="server" Font-Size="Large" style="z-index: 1; left: 449px; top: 315px; position: absolute" Text="Password"></asp:Label>
        <asp:Label ID="Label24" runat="server" style="z-index: 1; left: 380px; top: 432px; position: absolute" Text="New Password:"></asp:Label>
        <p>
        <asp:TextBox ID="TextBox8" runat="server" style="z-index: 1; left: 482px; top: 789px; position: absolute"></asp:TextBox>
        </p>
        <asp:Button ID="Button5" runat="server" style="z-index: 1; left: 431px; top: 839px; position: absolute" Text="Save Details" />
        ...
        <asp:Button ID="Button6" runat="server" style="z-index: 1; left: 395px; top: 1009px; position: absolute" Text="Enable/Disable 2FA" />
        ...
        <p>
            <asp:CheckBox ID="CheckBox3" runat="server" style="z-index: 1; left: 333px; top: 1278px; position: absolute" Text="I understand this action cannot be undone." />
        </p>
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="Button7" runat="server" style="z-index: 1; left: 318px; top: 1321px; position: absolute" Text="Delete Account/Stop Pending Deletion" />
        </p>
    </form>
</body>
</html>
