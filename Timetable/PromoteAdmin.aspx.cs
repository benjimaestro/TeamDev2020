...
namespace Timetable
{
    public partial class PromoteAdmin : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Users.Find(UserID);
            if (Users.ThisUser.Admin == true) { lblAdmin.Text = $"Are you sure you want to promote {Users.ThisUser.FullNameEmail} to admin?"; }
            else { lblAdmin.Text = $"Are you sure you want to demote {Users.ThisUser.FullNameEmail} from admin?"; }
        }
