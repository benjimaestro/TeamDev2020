...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 10px; top: 140px; position: absolute; " MaxLength="50" TextMode="Password"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox1" runat="server" style="z-index: 1; left: 10px; top: 328px; position: absolute" MaxLength="50"></asp:TextBox>
        <asp:Button ID="btnRegister" runat="server" style="z-index: 1; left: 10px; top: 430px; position: absolute; " Text="Save" OnClick="btnRegister_Click" />
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" style="z-index: 1; left: 10px; top: 389px; position: absolute; height: 38px; width: 129px;">
        </asp:DropDownList>
    </form>
</body>
</html>
