...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" style="z-index: 1; left: 754px; top: 212px; position: absolute" Text="Show All" />
        ...
        <asp:Button ID="Button2" runat="server" style="z-index: 1; left: 597px; top: 573px; position: absolute; width: 63px" Text="Edit" />
        <asp:Button ID="Button3" runat="server" ForeColor="Red" style="z-index: 1; left: 678px; top: 571px; position: absolute" Text="Delete " />
        <asp:Button ID="Button4" runat="server" style="z-index: 1; left: 1192px; top: 582px; position: absolute" Text="Back" />
        <p>
