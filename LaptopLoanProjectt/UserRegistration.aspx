...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnRegister" runat="server" style="z-index: 1; left: 458px; top: 424px; position: absolute; margin-top: 0px" Text="Register" OnClick="btnRegister_Click" />
        ...
        <asp:TextBox ID="txtFname" runat="server" style="z-index: 1; left: 468px; top: 125px; position: absolute; margin-top: 0px"></asp:TextBox>
        <asp:TextBox ID="txtLname" runat="server" style="z-index: 1; left: 470px; top: 162px; position: absolute"></asp:TextBox>
    </form>
</body>
</html>
